...
(function ($, anim) {
  ...
  var Dropdown = (function (_Component2) {
    ...
    function Dropdown(el, options) {
      ...
      _this7._handleDocumentClickBound =
        _this7._handleDocumentClick.bind(_this7);
      _this7._handleDropdownKeydownBound =
        _this7._handleDropdownKeydown.bind(_this7);
      _this7._handleTriggerKeydownBound =
        _this7._handleTriggerKeydown.bind(_this7);
            ...
            var enterAnimOptions = {
              ...
              complete: function () {
                if (typeof _this12.options.onOpenEnd === "function") {
                  _this12.options.onOpenEnd.call(
                    _this12,
                    _this12.el,
                    _this12._openingTrigger
                  );
                }
              },
            };
...
(function ($) {
  ...
  var Parallax = (function (_Component5) {
    ...
    function Parallax(el, options) {
      ...
      _this19._enabled =
        window.innerWidth > _this19.options.responsiveThreshold;
      ...
      [
        ...
        },
        {
          ...
          value: function _createIndicator() {
            ...
            setTimeout(function () {
              _this22._indicator.style.left =
                _this22._calcLeftPos(_this22.$activeTabLink) + "px";
              _this22._indicator.style.right =
                _this22._calcRightPos(_this22.$activeTabLink) + "px";
            }, 0);
          },
        ...
        },
        {
          ...
          value: function _renderDropdown(data, val) {
            ...
            var sortFunctionBound = function (a, b) {
              return _this36.options.sortFunction(
                a.key.toLowerCase(),
                b.key.toLowerCase(),
                val.toLowerCase()
              );
  ...
  var FeatureDiscovery = (function (_Component19) {
    ...
    function FeatureDiscovery(el, options) {
      ...
      var _this64 = _possibleConstructorReturn(
        this,
        (
          FeatureDiscovery.__proto__ || Object.getPrototypeOf(FeatureDiscovery)
        ).call(this, FeatureDiscovery, el, options)
      );
      ...
      [
        {
          ...
          value: function init(els, options) {
            return _get(
              FeatureDiscovery.__proto__ ||
                Object.getPrototypeOf(FeatureDiscovery),
              "init",
              this
            ).call(this, this, els, options);
          },
